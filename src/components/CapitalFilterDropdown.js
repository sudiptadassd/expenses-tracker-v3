...
export default function CapitalFilterDropdown({ capitals, selectedCapital, onSelect }) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-[var(--card)] border border-neutral-800 rounded-2xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-left">
                    <div className="p-1 max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-700">
                        <button
                            onClick={() => {
                                onSelect('all');
                                setIsOpen(false);
